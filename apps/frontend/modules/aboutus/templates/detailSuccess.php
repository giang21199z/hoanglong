        ...
        <div class="row" style="width: 1170px">
            <div class="left-content">
                <div class="row new-title">
                    ...
                    <p style="font-size: 18px ; color: #85a92a ;"><a href="<?php echo url_for('homepage') ?>"
                                                                     style="text-decoration: none; color: #B4CA7B">Trang
                            chủ </a> > <a href="<?php echo url_for('list_about_us') ?>"
                                          style="text-decoration: none; color: #B4CA7B">Giới thiệu </a>
                ...
                <div class="row pre">
                    <div class="col-md-5 col-md-offset-1 arr-left">
                        ...
                        <span>
                            <a style="text-decoration: none; color: #85A92A"
                               href="<?php echo url_for('detail_about_us', array('idaboutus' => $news_related[0]['idnews'], 'title' => $news_related[0]['title'])) ?>"><?php echo VtHelper::truncate($news_related[0]['title'], 25) ?></a>
                        </span>
                    </div>
                    <div class="col-md-5 arr-right">
                        ...
                        <span>
                            <a style="text-decoration: none; color: #85A92A"
                               href="<?php echo url_for('detail_about_us', array('idaboutus' => $news_related[1]['idnews'], 'title' => $news_related[1]['title'])) ?>"><?php echo VtHelper::truncate($news_related[1]['title'], 25) ?></a>
                        </span>
                    </div>
                </div>
