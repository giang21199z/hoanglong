...
class Constant
{
    ...
    public static $Display_Homepage = array(1 => ["label" => "Không ưu tiên", "class" => "label label-warning"], 2 => ["label" => "Hiển thị Why Choose US", "class" => "label label-success"]);
    public static $Display_Homepage_Cbx = array(1 => "Không ưu tiên", 2 => "Hiển thị Why Choose US");
}