...
/**
 * ervice form base class.
 *
 * @method ervice getObject() Returns the current form's model object
 *
 * @package    hoanglong
 * @subpackage form
 ...
 */
abstract class BaseerviceForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ervice[%s]');
