(function (h, g, c, j, e, k, f) {/*! Jssor */
    ...
    var b = h.$Jssor$ = new function () {
        var i = this, yb = /\S+/g, K = 1, ib = 2, lb = 3, kb = 4, ob = 5, L, s = 0, l = 0, t = 0, A = 0, B = 0, E = navigator, tb = E.appName, o = E.userAgent, z = g.documentElement, q = parseFloat;

        function Gb() {
            if (!L) {
                L = {Jf: "ontouchstart" in h || "createTouch" in g};
                var a;
        ...
        i.$WindowSize = function () {
            var a = g.body;
            return {x: a.clientWidth || z.clientWidth, y: a.clientHeight || z.clientHeight}
        };
        function w(c, d, a) {
        ...
        i.Yf = function (d, a) {
            if (a) d.style.clip = "rect(" + c.round(a.$Top || a.D || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.v || 0) + "px)"; else if (a !== f) {
        ...
        function x(g, l) {
            var e = fb(), b = H(), d = db(), h = M(g);

            function k(b, d, a) {
                var e = b.jb(p(-d / 2, -a / 2)), f = b.jb(p(d / 2, -a / 2)), g = b.jb(p(d / 2, a / 2)), h = b.jb(p(-d / 2, a / 2));
                b.jb(p(300, 300));
            ...
            x = function (e, c) {
                ...
                if (c.Ce)if (d) wb(i.$CreateCallback(j, O, e, c)); else a(e, c)
            };
            i.Db = O;
            if (d) i.Db = x;
            if (e) i.Db = a; else if (!b) a = O;
            i.N = x;
            x(g, l)
        }
        ...
        i.zc = function (c, d) {
            var a = c || {};
            if (c)if (b.od(c)) a = {eb: a}; else if (b.od(c.$Clip)) a.$Clip = {eb: c.$Clip};
            a.eb = a.eb || d;
        ...
        function ub(c, a) {
            ...
            n(c, function (c, d) {
                var e = c;
                if (a[d] != f)if (i.jc(c)) e = c + a[d]; else e = ub(c, a[d]);
                b[d] = e
            });
            return b
        }
        ...
        i.je = function (n, i, s, t, B, C, o) {
            ...
            if (n) {
                ...
                for (var h in i) {
                    ...
                    var x = c.floor(g);
                    if (g != x) g -= x;
                    var k = t.eb || d.$Linear, m, E = n[h], q = i[h];
                    if (b.jc(q)) {
                        k = t[h] || k;
                        var A = k(g);
                        m = E + q * A
            ...
            if (i.$Clip && o.$Move) {
                var p = a.$Clip.Tb, v = (p.$Top || 0) + (p.$Bottom || 0), u = (p.$Left || 0) + (p.$Right || 0);
                a.$Left = (a.$Left || 0) + u;
                a.$Top = (a.$Top || 0) + v;
                a.$Clip.$Left -= u;
                a.$Clip.$Right -= u;
    ...
    var l = function (A, D, g, L, O, J) {
        A = A || 0;
        var a = this, p, m, n, t, B = 0, H, I, G, C, z = 0, i = 0, l = 0, y, j, d, f, o, x, v = [], w;
        ...
        function s(p) {
            var h = p;
            if (o)if (!x && (h >= f || h < d) || x && h >= d) h = ((h - d) % o + o) % o + d;
            if (!y || t || i != h) {
                var k = c.min(h, f);
                k = c.max(k, d);
                if (!y || t || k != l) {
        ...
        function K() {
            if (p) {
                var d = b.V(), e = c.min(d - B, g.Pd), a = i + e * n;
                B = d;
                if (a * n >= m * n) a = m;
                s(a);
    ...
    var o = h.$JssorSlideshowFormations$ = new function () {
        ...
        h.$FormationStraight = function (f) {
            for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.dc, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)for (a = 0; a < d; a++) {
                switch (s) {
                    case j:
                        c = h - (a * e + (q - b));
                        break;
        ...
        h.$FormationSwirl = function (q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.dc, A = [], z = [], u = 0, c = 0, h = 0, r = x - 1, s = y - 1, t, p, v = 0;
            switch (B) {
                case j:
                    c = r;
                    h = 0;
        ...
        h.$FormationZigZag = function (p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.dc, t = [], u = 0, c = 0, e = 0, q = w - 1, r = x - 1, y, h, s = 0;
            switch (z) {
                case j:
                    c = q;
                    e = 0;
        ...
        h.$FormationStraightStairs = function (q) {
            var u = q.$Cols, v = q.$Rows, e = q.$Assembly, t = q.dc, r = [], s = 0, c = 0, d = 0, f = u - 1, h = v - 1, x = t - 1;
            switch (e) {
                case j:
                case m:
                case o:
    ...
    h.$JssorSlideshowRunner$ = function (n, s, q, u, z, A) {
        ...
        function i(g, f) {
            ...
            a.Je = function (c, b) {
                ...
                if (!a.Lb[f]) {
                    a.Lb[f] = {T: c, W: b};
                    for (var d = 0; d < a.$Cols; d++)for (var e = 0; e < a.$Rows; e++)a.Lb[f][e + "," + d] = {
                        $Top: e * b,
                        $Right: d * c + c,
                        $Bottom: e * b + b,
                        $Left: d * c
        ...
        function p(B, h, a, v, n, l) {
            var y = this, t, u = {}, i = {}, m = [], f, d, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0, g = a.Je(n, l), o = C(a), D = o.length - 1, s = a.$Duration + a.$Delay * D, w = v + s, j = a.$SlideOut, x;
            w += 50;
            function C(a) {
                var b = a.$Formation(a);
            ...
            y.Sb = function (d) {
                ...
                if (e || x) {
                    ...
                    b.$Each(i, function (a, e) {
                        ...
                        if (a.se != d) {
                            if (!a.se && !j) b.u(m[e]); else d == a.ye && j && b.R(m[e]);
                            a.se = d;
                            b.N(m[e], a[d])
                        }
                    })
            ...
            b.$Each(o, function (h, m) {
                b.$Each(h, function (G) {
                    var K = G[0], J = G[1], v = K + "," + J, o = k, s = k, x = k;
                    if (p && J % 2) {
                        if (p & 3) o = !o;
                        if (p & 12) s = !s;
                        if (p & 16) x = !x
                    ...
                    var C = s ? a.$Bottom : a.$Top, z = s ? a.$Top : a.$Bottom, B = o ? a.$Right : a.$Left, A = o ? a.$Left : a.$Right;
                    a.$Clip = C || z || B || A;
                    r = {};
                    d = {D: 0, v: 0, $Opacity: 1, T: n, W: l};
                    f = b.p({}, d);
                    t = b.p({}, g[v]);
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        var H = e;
                        if (b.Ub())if (a.$Cols * a.$Rows > 1) H = k; else I = k;
                        if (H) {
                    ...
                    if (I) {
                        ...
                        if (a.$Clip) {
                            ...
                            if (C && z) {
                                h.$Top = g.W / 2 * w;
                                h.$Bottom = -h.$Top
                            } else if (C) h.$Bottom = -g.W * w; else if (z) h.$Top = g.W * w;
                            if (B && A) {
                                h.$Left = g.T / 2 * w;
                                h.$Right = -h.$Left
                            } else if (B) h.$Right = -g.T * w; else if (A) h.$Left = g.T * w
                        }
                        r.$Clip = t;
                        f.$Clip = g[v]
                    }
                    ...
                    b.$Each(d, function (a, c) {
                        if (b.jc(a))if (a != f[c]) r[c] = a - f[c]
                    });
                    u[v] = j ? f : d;
                    var D = a.Me, y = c.round(m * a.$Delay / a.$Interval);
                    i[v] = new Array(y);
                    i[v].De = y;
                    i[v].ye = y + D - 1;
                    for (var F = 0; F <= D; F++) {
        ...
        f.Re = function (w, x, k, l, b) {
            ...
            j["no-image"] = !l.lc;
            e["no-image"] = !k.lc;
            var m = j, o = e, u = b, d = b.$Brother || i({}, h);
            if (!b.$SlideOut) {
                m = e;
                o = j
            }
    ...
    var i = h.$JssorSlider$ = function (q, hc) {
        ...
        function Ec() {
            ...
            l.call(b, -1e8, 2e8);
            b.Pe = function () {
                var a = b.Ab(), d = c.floor(a), f = v(d), e = a - c.floor(a);
                return {tb: f, Sf: d, Kb: e}
            };
            b.Pb = function (d, b) {
                var f = c.floor(b);
                if (f != b && b > d) f++;
        ...
        function Cc() {
            var a = this, b = Wb.$Elmt;
            l.call(a, -1, 2, {$Easing: d.$Linear, He: {Kb: bc}, Gc: s}, b, {Kb: 1}, {Kb: -2});
            a.hc = b
        }

        function rc(n, m) {
            var b = this, d, f, g, h, c;
            l.call(b, -1e8, 2e8, {Pd: 100});
            b.Ed = function () {
                Q = e;
                S = j;
        ...
        function Ac(h, f) {
            var d = this, q, N, y, n, z = [], x, E, U, H, R, D, K, g, t, p;
            l.call(d, -w, w + 1, {});
            function F(a) {
                q && q.zd();
                T(h, a, 0);
            ...
            function P(p, r, m) {
                if (!H) {
                    H = e;
                    if (n && m) {
                        var g = m.width, c = m.height, l = g, j = c;
                        if (g && c && o.$FillMode) {
            ...
            function ab(b) {
                if (b == S && r == f) {
                    if (!g) {
                        var a = j;
                        if (C)if (C.tb == f) a = C.Ne(); else C.Cb();
                        Y();
                        g = new yc(h, f, a, q);
                        g.nd(p)
                    }
            ...
            function G(a, e, k) {
                if (a == f) {
                    if (a != e) B[e] && B[e].sd(); else!k && g && g.mg();
                    p && p.$Enable();
                    var l = S = b.V();
                    d.Gb(b.$CreateCallback(j, ab, l))
                } else {
                    var i = c.min(f, a), h = c.max(f, a), n = c.min(h - i, i + s - h), m = w + o.$LazyLoading - 1;
                    (!R || n <= m) && d.Gb()
                }
            }
            ...
            function T(a, d, c, h) {
                ...
                var i = b.$Children(a);
                b.$Each(i, function (f) {
                    var i = f.tagName, j = b.$AttributeEx(f, "u");
                    if (j == "player" && !t) {
                        t = f;
                        if (t.pInstance) Q(); else b.$AddEvent(t, "dataavailable", Q)
                    }
                    if (j == "caption") {
                        if (d) {
                        ...
                        if (i == "A") {
                            if (b.$AttributeEx(f, "u") == "image") n = b.og(f, "IMG"); else n = b.$FindChild(f, "image", e);
                            if (n) {
                                x = f;
                                b.hb(x, "block");
                                b.N(x, W);
        ...
        function yc(z, g, p, q) {
            var c = this, n = 0, v = 0, h, j, f, d, m, t, s, o = B[g];
            l.call(c, 0, 0);
            function w() {
                b.Jc(K);
            ...
            c.wc = function () {
                ...
                if (!D && !Q && !s && r == g) {
                    ...
                    if (b != d)if (b == f) k = d; else if (b == j) k = f; else if (!b) k = j; else k = c.Hd();
                    a.m(p, g, b, n, j, f, d);
                    var l = u && (!E || F);
                    if (b == d) (f != d && !(E & 12) || l) && o.cf(); else(l || b != f) && c.Jd(k, x)
                }
            };
            c.mg = function () {
                f == d && f == c.Ab() && c.L(j)
        ...
        function bc(c, b) {
            var a = y > 0 ? y : ib, d = Db * b * (a & 1), e = Eb * b * (a >> 1 & 1);
            tb(c, d, e)
        }
        ...
        function Fb(d) {
            if (D) {
                ...
                if (f) {
                    var j = f.x - xb, k = f.y - yb;
                    if (c.floor(G) != G) y = y || ib & O;
                    if ((j || k) && !y) {
                        if (O == 3)if (c.abs(k) > c.abs(j)) y = 2; else y = 1; else y = O;
                    ...
                    if (y) {
                        ...
                        if (H - db < -2) gb = 0; else if (H - db > 2) gb = -1;
                        db = H;
                        H = a;
                        ub = G - H / i / (bb || 1);
                        if (H && y && !Cb) {
                            b.$CancelEvent(d);
                            if (!Q) A.Mf(ub); else A.Kf(ub)
                        }
                    }
                }
            }
        ...
        function Ib(h, g, l, m) {
            if (Ub && (!D && (F || !(E & 12)) || o.$NaviQuitDrag)) {
                ...
                var a = b;
                if (!(N & 1))if (m) a = v(b); else {
                    a = c.max(0, c.min(b, s - w));
                    if (a == P)if (N & 2) a = a ? 0 : s - w
                }
                var j = (a - d) % s;
                a = d + j;
        ...
        a.ae = function (a) {
            var d = c.ceil(v(hb / dc)), b = v(a - P + d);
            if (b > w) {
                if (a - P > s / 2) a -= s; else if (a - P <= -s / 2) a += s
            } else a = P + b - d;
            return a
        };
        m.call(a);
        ...
        var ib = o.$PlayOrientation & 3, fb = o.$SlideshowOptions, I = b.p({
            $Class: p,
            $PlayInMode: 1,
            $PlayOutMode: 1,
            $HWA: o.$HWA
    ...
    h.$JssorBulletNavigator$ = function (d, C) {
        ...
        m.call(f);
        d = b.$GetElement(d);
        var s, A, z, r, l = 0, a, o, i, w, x, h, g, q, p, B = [], y = [];
        ...
        f.Fc = function (E) {
            if (!u) {
                s = c.ceil(E / o);
                l = 0;
                var n = q + w, r = p + x, m = c.ceil(s / i) - 1;
                A = q + n * (!h ? m : i - 1);
                z = p + r * (h ? m : i - 1);
                b.$CssWidth(d, A);
                b.$CssHeight(d, z);
        ...
        f.Nb = a = b.p({$SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1}, C);
    ...
    h.$JssorThumbnailNavigator$ = function (g, B) {
        var h = this, y, p, a, v = [], z, x, d, q, r, u, t, o, s, f, l;
        m.call(h);
        g = b.$GetElement(g);
        function A(q, f) {
            var g = this, c, o, m;
            ...
            function i(g) {
                if (g || !s.$LastDragSucceded()) {
                    var a = d - f % d, b = s.ae((f + a) / d - 1), c = b * d + d - a;
                    h.m(n.ic, c, k, e)
                }
            }
        ...
        h.Fc = function (F, D) {
            if (!w) {
                ...
                b.$Each(D, function (l, g) {
                    var i = new A(l, g), e = i.hc, a = c.floor(g / d), k = g % d;
                    b.B(e, (u + q) * k * (1 - h));
                    b.C(e, (t + r) * k * h);
                    if (!j[a]) {
                        j[a] = b.$CreateDiv();
        ...
        h.Nb = a = b.p({$SpacingX: 0, $SpacingY: 0, $Cols: 1, $Orientation: 1, $AutoCenter: 3, $ActionMode: 1}, B);
        z = b.$CssWidth(g);
        x = b.$CssHeight(g);
    ...
    h.$JssorCaptionSlideo$ = function (v, i, u, E) {
        var a = this, w, o = {}, p = i.$Transitions, s = i.$Controls, m = new l(0, 0), q = [], g = [], D = E, f = D ? 1e8 : 0;
        l.call(a, 0, 0);
        function r(d, c) {
            var a = {};
            b.$Each(d, function (d, f) {
                var e = o[f];
                if (e) {
                    if (b.Qd(d)) d = r(d, c || f == "e"); else if (c)if (b.jc(d)) d = w[d];
                    a[e] = d
                }
            });
            return a
        ...
        function t(d, e) {
            var a = [], c = b.$Children(d);
            b.$Each(c, function (c) {
                var h = b.$AttributeEx(c, "u") == "caption";
                if (h) {
                    var d = b.$AttributeEx(c, "t"), g = p[b.oc(d)] || p[d], f = {$Elmt: c, pc: g};
                    a.push(f)
                }
                a = a.concat(t(c, e + 1))
            });
        ...
        function z(t, u, g) {
            ...
            b.$Each(u, function (i) {
                var h = b.p(e, {}, r(i)), j = b.zc(h.$Easing);
                delete h.$Easing;
                if (h.$Left) {
                    h.v = h.$Left;
                    j.v = j.$Left;
                ...
                var o = {$Easing: j, $OriginalWidth: g.T, $OriginalHeight: g.W}, k = new l(i.b, i.d, o, t, g, h);
                f = c.max(f, i.b + i.d);
                if (a) {
                    if (!d) d = new l(i.b, 0);
                    d.P(k)
            ...
            if (a && d) {
                d.Ke();
                var h = d, k, i = d.Vb(), p = d.mb(), q = c.max(p, a.Ge);
                if (a.Y < p) {
                    if (a.Y > i) {
                        h = new l(i, a.Y - i);
                        h.P(d, e)
                    } else h = j;
                    k = new l(a.Y, q - i, {Gc: q - a.Y, xe: e});
                    k.P(d, e)
                }
                h && a.Oc.push(h);
                k && a.Yd.push(k)
        ...
        function h(k, d, e) {
            ...
            if (g > 4)for (var m = c.ceil(g / 4), a = 0; a < m; a++) {
                var i = d.slice(a * 4, c.min(a * 4 + 4, g)), j = new l(i[0].Y, 0);
                h(j, i, e);
                k.P(j)
        ...
        y(t(v, 1));
        h(m, g);
        var x = i.$Breaks || [], k = [].concat(x[b.oc(b.$AttributeEx(v, "b"))] || []);
